...
if (file.exists("detail.csv") == TRUE) {
  ...
  nbr_rows <- nrow(scr)
  log4r::debug(logger, paste("catchup",symbol1,group1,dt1,pproc1,method1,nbr_rows)) 
  ...
  log4r::debug(logger,paste("catchup", "data date=",lastddate,"scr date=",lastsdate,"ppb=",ppb))
