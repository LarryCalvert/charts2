#https://www.youtube.com/watch?v=oya4p2fXrRY&list=PL9Qz5ExA-BO9vq9FdBIaQeuZ9MGFrgCaj&index=17
#https://github.com/jgQuantScripts/get-Futures-OHLCV
#https://github.com/jgQuantScripts/get-Futures-OHLCV/blob/main/barChartFutures_Daily.R
...
getFutQuotes = function(ticker){
  ...
  # page url
  pg <- session(paste0("https://www.barchart.com/futures/quotes/",ticker,"/price-history/historical"))
  # save page cookies
...
# get the list of contracts available
# page url
####### getting 403 - needs header to emulate a browser ##############
